...
class HopperEnv(DFlexEnv):
    ...
    def __init__(self, device='cuda:0', num_envs=4096, seed=0, episode_length=1000, img_height=84, img_width=84, no_grad=True, stochastic_init=False, MM_caching_frequency=1, early_termination=True):
        ...
        super(HopperEnv, self).__init__(num_envs, num_state_obs, num_act, episode_length, MM_caching_frequency, seed, 
        ...
        self.renderer = ManiskillViewer(env_name="HopperVis", num_env=num_envs, height=img_height, width=img_width)
